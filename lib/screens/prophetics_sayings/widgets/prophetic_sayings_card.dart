...
import 'package:sahabul_azkar/screens/prophetics_sayings/prophetic_sayings_detail_screen.dart';
import 'package:sahabul_azkar/utils/app_colors.dart';
import 'package:sahabul_azkar/utils/app_vectors.dart';

class PropheticSayingsCard extends StatelessWidget {
  //final GestureTapCallback onTap;
  final String title;
  final Color? color;
  const PropheticSayingsCard(
            ...
            child: ListTile(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return PropheticSayingsDetailScreen(color: color);
                  }));
                })),
        const SizedBox(
          height: 8,
