...
class PropheticSayingsDetailScreen extends StatefulWidget {
  final Color? color;
  const PropheticSayingsDetailScreen({Key? key, this.color}) : super(key: key);

  @override
  State<PropheticSayingsDetailScreen> createState() =>
      _PropheticSayingsDetailScreenState();
}

class _PropheticSayingsDetailScreenState
    extends State<PropheticSayingsDetailScreen> {
